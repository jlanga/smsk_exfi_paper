...
rule table02_comparison:
    """
    Comparison across different species.
    Exfi: m=4G except plam and amex because of the number of kmers
    GMAP: default, using gmapl on amex and plam
    ChopStitch:
    - k=25, fpr1 = fpr2 = 0.01 when possible, minimum fpr otherwise:
        - hsap: 15% + 15%
        - amex:
    - k=50, fpr1=20%, fpr2 in 1,5,10,15,20%
    """
    input:
        # -- with reference genome --
        ## drer
        ...
        BWA + "drer.k25.l2.m4.100.baited.exfi.stats.tsv",
        BWA + "drer.k25.fpr0.01.chopstitch.stats.tsv",
        BWA_R + "drer.k_50.fpr1_0.01.fpr2_0.01.chopstitch.stats.tsv",
        BWA + "drer.gmap.stats.tsv",
        ## hsap
        PR + "hsap.k25.l2.m4.100.baited.exfi.0.95.tsv",
        PR + "hsap.k25.fpr0.15.chopstitch.0.95.tsv",
        ...
        PR + "ssal.k25.l2.m4.100.baited.exfi.0.95.tsv",
        PR + "ssal.k25.fpr0.01.chopstitch.0.95.tsv",
        PR_R + "ssal.k_50.fpr1_0.01.fpr2_0.01.chopstitch.stats.tsv",
        PR + "ssal.gmap.0.95.tsv",
        BWA + "ssal.k25.fpr0.01.chopstitch.stats.tsv",
        ...
        PR + "char_ref.k25.l2.m4.100.baited.exfi.0.95.tsv",
        PR + "char_ref.k25.fpr0.01.chopstitch.0.95.tsv",
        PR_R + "char_ref.k_50.fpr1_0.01.fpr2_0.01.chopstitch.0.95.tsv",
        PR + "char_ref.gmap.0.95.tsv",
        BWA + "char_ref.k25.fpr0.01.chopstitch.stats.tsv",
        ...
        ## amex
        BWA + "amex.k25.l2.m60.100.baited.exfi.stats.tsv",
        BWA + "amex.k25.fpr0.20.chopstitch.stats.tsv",
        expand(
            BWA_R + "amex.k_{kmer}.fpr1_{fpr1}.fpr2_{fpr2}.chopstitch.stats.tsv",
            kmer=50,
            fpr1="0.20".split(),
            fpr2="0.10 0.15 0.20".split()
        ),
        # gmap failed
        ## plam
        BWA + "plam.k25.l2.m60.100.baited.exfi.stats.tsv",
        ...
        #     identity="0.95"
        # ),
        # PR_R + "hsap.k_50.fpr1_0.15.fpr2_0.10.chopstitch.0.95.tsv",  # Nope
        # PR_R + "hsap.k_50.fpr1_0.15.fpr2_0.15.chopstitch.0.95.tsv",  # Not even the same parameters as in k=25
        # expand(  # None of these work
        #     BWA_R + "{sample}.k_{kmer}.fpr1_{fpr1}.fpr2_{fpr2}.chopstitch.stats.tsv",
        #     sample=["hsap"],
        #     kmer=50,
        ...
        #     identity="0.95"
        # ),
        # BWA_R + "hsap.k_50.fpr1_0.15.fpr2_0.10.chopstitch.stats.tsv",
        # BWA_R + "hsap.k_50.fpr1_0.15.fpr2_0.15.chopstitch.stats.tsv",
        ## amex - failed
        # BWA + "amex.k25.fpr0.01.chopstitch.stats.tsv",  # std::mem_alloc()
        # BWA + "amex.k25.l2.m4.100.baited.exfi.stats.tsv",  # FPR too high
        # BWA + 'amex.gmap.stats.tsv',  # Loads the index, maps, but after a while clogs the RAM
        # expand(  # None worked - FPR1 = 20% -> 200 Gb
        #     BWA_R + "amex.k_{kmer}.fpr1_{fpr1}.fpr2_{fpr2}.chopstitch.stats.tsv",
        #     kmer=50,
        #     fpr1="0.20".split(),
        #     fpr2="0.01 0.05".split()
        ...
        ## plam - failed
        # BWA + "plam.k25.fpr0.01.chopstitch.stats.tsv",  # std::mem_alloc()
        # expand(  # None worked - FPR1 = 20% -> 300 Gb
        #     BWA_R + "plam.k_{kmer}.fpr1_{fpr1}.fpr2_{fpr2}.chopstitch.stats.tsv",
        #     kmer=50,
        #     fpr1="0.20".split(),
        #     fpr2="0.01 0.05".split()
        # ),
        # BWA + "plam.k25.l2.m4.100.baited.exfi.stats.tsv",  # Not used



rule exfi_baited_vs_unbaited_drer:
    ...
    stable02_baited_vs_unbaited_drer
    figure03_baited_vs_unbaited_drer
    """
    input:
        expand(
...
rule exfi_baited_vs_unbaited_hsap:
    """With the human dataset, find the PR and Mapping stats when using 4 and 60
    GB, baiting or not.

    stable03_baited_vs_unbaited_hsap
    sfigure01_baited_vs_unbaited_hsap
    """
    input:
        expand(
            PR + "hsap.k25.l2.m{size}.100.{type}.exfi.0.95.tsv",
            size=[4, 60],
            type=["unbaited", "baited"],
        ),
        expand(
            BWA + "hsap.k25.l2.m{size}.100.{type}.exfi.stats.tsv",
            size=[4, 60],
            type=["unbaited", "baited"],
        )
...
rule exfi_optimal_depth:
    ...
    stable05_optimal_depth
    figure05_optimal_depth
    """
    input:
        expand(
...
rule classification_drer:
    """
    exfi k=25, m in [4:60:4]
    cs k = 25, fpr1 in (1-20%), fpr2 == 1%
    cs k = 50, fpr1 in (1-20%), fpr2 == 1%
    gmap default

    st06_classification_drer
    f06_comparison_drer
    """
    input:
        expand( # EXFI PR, baited and unbaited, multiple memories
            PR + "drer.k25.l2.m{size}.100.{type}.exfi.0.95.tsv",
            size=range(4, 60 + 1, 4),
            type=["unbaited", "baited"]
        ),
        expand(  # EXFI BWA, baited and unbaited, multiple memories
            BWA + "drer.k25.l2.m{size}.100.{type}.exfi.stats.tsv",
            size=range(4, 60 + 1, 4),
            type=["unbaited", "baited"]
        ),
        expand(  # CS PR, both k values, fpr2 fixed to 1%
            PR_R + "drer.k_{kmer}.fpr1_{fpr1}.fpr2_{fpr2}.chopstitch.0.95.tsv",
            kmer=[25,50],
            fpr1="0.01 0.05 0.10 0.15 0.20".split(),
            fpr2="0.01".split()
        ),
        expand(  # CS BWA, both k values, fpr2 fixed to 1%
            BWA_R + "drer.k_{kmer}.fpr1_{fpr1}.fpr2_{fpr2}.chopstitch.stats.tsv",
            kmer=[25, 50],
            fpr1="0.01 0.05 0.10 0.15".split(),
            fpr2="0.01".split()
        ),
...
rule classification_hsap:
    """
    exfi k=25, mem in 4, 60 GB
    cs:
        - k=25, fpr1=15% fpr2 minimal
        - k=50, fpr1=15%, fpr2 minimum - doesn't work
    gmap: default

    stable07_classification_hsap
    sfigure01_classification_hsap
    """
    input:
        PR + "hsap.k25.l2.m4.100.baited.exfi.0.95.tsv",
        PR + "hsap.k25.l2.m60.100.baited.exfi.0.95.tsv",
        BWA + "hsap.k25.l2.m4.100.baited.exfi.stats.tsv",
        BWA + "hsap.k25.l2.m60.100.baited.exfi.stats.tsv",
        expand(  # CS PR, both k values, fpr2 fixed to 1% - CS k=50 won't work
            PR_R + "hsap.k_{kmer}.fpr1_{fpr1}.fpr2_{fpr2}.chopstitch.0.95.tsv",
            kmer="25".split(),
            fpr1="0.15".split(),
            fpr2="0.05 0.10 0.15 0.20".split()
        ),
        expand(  # CS BWA, both k values, fpr2 fixed to 1% - k=50 won't work
            BWA_R + "hsap.k_{kmer}.fpr1_{fpr1}.fpr2_{fpr2}.chopstitch.stats.tsv",
            kmer="25".split(),
            fpr1="0.15".split(),
            fpr2="0.05 0.10 0.15 0.20".split()
        ),
...
rule cs_amex:
    """
    Find out the values that work for amex.
    - k = 50 is not possible
    - FPR1 < 20% is impossible
    """
    input:
        # BWA_R + "amex.k_25.fpr1_0.20.fpr2_0.20.chopstitch.stats.tsv",  # Already done in first revision
        BWA_R + "amex.k_25.fpr1_0.20.fpr2_0.15.chopstitch.stats.tsv",
        BWA_R + "amex.k_25.fpr1_0.20.fpr2_0.10.chopstitch.stats.tsv"


rule all:
    input:
        rules.comparison_species.input,
        rules.table02_comparison.input,
        rules.exfi_baited_vs_unbaited_drer.input,
        rules.exfi_baited_vs_unbaited_hsap.input,
        rules.exfi_optimal_k.input,
        rules.exfi_optimal_depth.input,
        rules.classification_drer.input,
        rules.classification_hsap.input